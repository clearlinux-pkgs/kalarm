...
%setup -q -n kalarm-24.12.2
cd %{_builddir}/kalarm-24.12.2
pushd ..
cp -a kalarm-24.12.2 buildavx2
popd
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libkalarmcalendar.so.6.3.2
/V3/usr/lib64/libkalarmplugin.so.6.3.2
/V3/usr/lib64/qt6/plugins/pim6/kalarm/akonadiplugin.so
/usr/lib64/libkalarmcalendar.so.6
/usr/lib64/libkalarmcalendar.so.6.3.2
/usr/lib64/libkalarmplugin.so.6
/usr/lib64/libkalarmplugin.so.6.3.2
