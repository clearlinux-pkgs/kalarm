...
Version  : 22.12.3
Release  : 57
URL      : https://download.kde.org/stable/release-service/22.12.3/src/kalarm-22.12.3.tar.xz
Source0  : https://download.kde.org/stable/release-service/22.12.3/src/kalarm-22.12.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.12.3/src/kalarm-22.12.3.tar.xz.sig
...
%prep
%setup -q -n kalarm-22.12.3
cd %{_builddir}/kalarm-22.12.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677802307
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libkalarmcalendar.so.5.22.3
/usr/lib64/libkalarmplugin.so.5
/usr/lib64/libkalarmplugin.so.5.22.3
