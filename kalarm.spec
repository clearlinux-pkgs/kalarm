...
Source0  : https://download.kde.org/stable/release-service/24.02.1/src/kalarm-24.02.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.02.1/src/kalarm-24.02.1.tar.xz.sig
...
%prep
%setup -q -n kalarm-24.02.1
cd %{_builddir}/kalarm-24.02.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711130344
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libkalarmcalendar.so.6.0.1
/V3/usr/lib64/libkalarmplugin.so.6.0.1
/V3/usr/lib64/qt6/plugins/pim6/kalarm/akonadiplugin.so
/usr/lib64/libkalarmcalendar.so.6
/usr/lib64/libkalarmcalendar.so.6.0.1
/usr/lib64/libkalarmplugin.so.6
/usr/lib64/libkalarmplugin.so.6.0.1
