...
Version  : 23.08.5
Release  : 69
URL      : https://download.kde.org/stable/release-service/23.08.5/src/kalarm-23.08.5.tar.xz
Source0  : https://download.kde.org/stable/release-service/23.08.5/src/kalarm-23.08.5.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.08.5/src/kalarm-23.08.5.tar.xz.sig
...
%prep
%setup -q -n kalarm-23.08.5
cd %{_builddir}/kalarm-23.08.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1708451335
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libkalarmcalendar.so.5.24.5
/V3/usr/lib64/libkalarmplugin.so.5.24.5
/V3/usr/lib64/qt5/plugins/pim5/kalarm/akonadiplugin.so
/usr/lib64/libkalarmcalendar.so.5
/usr/lib64/libkalarmcalendar.so.5.24.5
/usr/lib64/libkalarmplugin.so.5
/usr/lib64/libkalarmplugin.so.5.24.5
