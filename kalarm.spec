...
Source0  : https://download.kde.org/stable/release-service/24.08.2/src/kalarm-24.08.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.08.2/src/kalarm-24.08.2.tar.xz.sig
...
%setup -q -n kalarm-24.08.2
cd %{_builddir}/kalarm-24.08.2
pushd ..
cp -a kalarm-24.08.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1728855128
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libkalarmcalendar.so.6.2.2
/V3/usr/lib64/libkalarmplugin.so.6.2.2
/V3/usr/lib64/qt6/plugins/pim6/kalarm/akonadiplugin.so
/usr/lib64/libkalarmcalendar.so.6
/usr/lib64/libkalarmcalendar.so.6.2.2
/usr/lib64/libkalarmplugin.so.6
/usr/lib64/libkalarmplugin.so.6.2.2
