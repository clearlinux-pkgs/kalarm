...
Source0  : https://download.kde.org/stable/release-service/24.05.0/src/kalarm-24.05.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.05.0/src/kalarm-24.05.0.tar.xz.sig
...
%setup -q -n kalarm-24.05.0
cd %{_builddir}/kalarm-24.05.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1716586373
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libkalarmcalendar.so.6.1.0
/V3/usr/lib64/libkalarmplugin.so.6.1.0
/V3/usr/lib64/qt6/plugins/pim6/kalarm/akonadiplugin.so
/usr/lib64/libkalarmcalendar.so.6
/usr/lib64/libkalarmcalendar.so.6.1.0
/usr/lib64/libkalarmplugin.so.6
/usr/lib64/libkalarmplugin.so.6.1.0
