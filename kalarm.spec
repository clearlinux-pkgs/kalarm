...
Source0  : https://download.kde.org/stable/release-service/22.08.0/src/kalarm-22.08.0.tar.xz
...
%prep
%setup -q -n kalarm-22.08.0
cd %{_builddir}/kalarm-22.08.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661566144
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libkalarmcalendar.so.5.21.0
/usr/lib64/libkalarmplugin.so.5
/usr/lib64/libkalarmplugin.so.5.21.0
