...
%prep
%setup -q -n kalarm-19.12.0
cd %{_builddir}/kalarm-19.12.0
...
cp %{_builddir}/kalarm-19.12.0/COPYING.DOC %{buildroot}/usr/share/package-licenses/kalarm/1bd373e4851a93027ba70064bd7dbdc6827147e1
cp %{_builddir}/kalarm-19.12.0/COPYING.LIB %{buildroot}/usr/share/package-licenses/kalarm/9a1929f4700d2407c70b507b3b2aaf6226a9543c
cp %{_builddir}/kalarm-19.12.0/cmake/modules/COPYING-CMAKE-SCRIPTS %{buildroot}/usr/share/package-licenses/kalarm/ff3ed70db4739b3c6747c7f624fe2bad70802987
pushd clr-build
%make_install
popd
%find_lang kalarm
