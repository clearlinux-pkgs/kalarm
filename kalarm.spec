...
Version  : 24.08.1
Release  : 80
URL      : https://download.kde.org/stable/release-service/24.08.1/src/kalarm-24.08.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.08.1/src/kalarm-24.08.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.08.1/src/kalarm-24.08.1.tar.xz.sig
...
%setup -q -n kalarm-24.08.1
cd %{_builddir}/kalarm-24.08.1
pushd ..
cp -a kalarm-24.08.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726506419
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libkalarmcalendar.so.6.2.1
/V3/usr/lib64/libkalarmplugin.so.6.2.1
/V3/usr/lib64/qt6/plugins/pim6/kalarm/akonadiplugin.so
/usr/lib64/libkalarmcalendar.so.6
/usr/lib64/libkalarmcalendar.so.6.2.1
/usr/lib64/libkalarmplugin.so.6
/usr/lib64/libkalarmplugin.so.6.2.1
